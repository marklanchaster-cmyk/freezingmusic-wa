# freezingmusic-wa
# Note that this service was created in hand with AI as I couldn't find another project that did what I wanted and I dont have the skills to make something of this complexity on my own.

The serverside / webapp version of the service

This will not see a pubic release for a long time, as such, no actutal files will be added to this repository.

The main point of this repo at the moment will be to document changes and updates made to the backend server and webapp. 

When i feel the backend server and setup is good, I will update this with proper instruction


# Scope

The main function of this application is to make a personal streaming service close to what Spotify does with its visuals and general behavior.
...
> Playlist Creation
> 
> Functional Queue with Shuffle, Looping and Song insertion
> 
> Timed Lyric Events (For songs that have Lyrics available, not every song will)
>
> Spotify Library Importing
>
